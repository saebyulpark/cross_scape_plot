...
switch pitch_or_rhythm 
    case 1
        colormap(flipud(hot))
         h.FontSize = 15
        set(get(h,'label'),'string','Pitch Similarity');
    case 2
        ...
        colormap(mymap)
        h.FontSize = 15
        set(get(h,'label'),'string','Rhythm Similarity');
end

caxis([0,1])
xlabel('Segment Center (Note Level)', 'Fontsize', 15,'FontName','Arial') 
ylabel('Segment Length (Note Level)', 'Fontsize', 15,'FontName','Arial') 
